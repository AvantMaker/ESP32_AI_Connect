 ...
 * after long idle periods or temporary network issues. The feature is enabled by
 * default and works transparently in the background.
 * 
 ...
 * 
 * Setup Instructions:
 * 1. Auto-retry is enabled by default - no configuration needed!
 * 2. Update WiFi credentials and API key below
 * 3. Upload and monitor Serial output (115200 baud)
 * 
 * To disable auto-retry: #define DISABLE_AUTO_RETRY before including the library
 * 
 * Testing Scenarios:
...
void setup() {
    ...
    Serial.println("  To enable: Remove DISABLE_AUTO_RETRY define from your sketch");
#endif
    Serial.println("===================================\n");
...
void testAIRequest() {
    ...
    if (response.length() > 0) {
        ...
        Serial.println("  Remove DISABLE_AUTO_RETRY define from your sketch");
#endif
    }
...
void testIdleScenario() {
    ...
    Serial.println("Remove DISABLE_AUTO_RETRY define from your sketch to enable.");
    Serial.println("========================================\n");
#endif
}
